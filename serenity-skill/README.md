...
```bash
python3 install-skill-from-github.py --repo muxuuu/serenity-skill --path . --name serenity-skill
```

安装路径：`~/.codex/skills/serenity-skill`

安装后重启 Codex 即可在对话中使用此技能。

如需在其他 Agent Skills 客户端手动安装：
